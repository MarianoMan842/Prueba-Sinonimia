...
document.addEventListener("keydown", (event) => {
  if (event.key === "s" || event.key === "S") {
    ...
    if(sinonimo === 'enmierdar'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['enmerdar']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'austero'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['severo', 'rigorista', 'rígido', 'riguroso', 'estricto', 'serio', 'grave', 'sobrio', 'moderado', 'continente', 'espartano', 'parco', 'templado', 'frugal', 'mesurado', 'prudente', 'económico', 'ahorrativo', 'reflexivo', 'puritano', 'temperado', 'penitente']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'gozne'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['charnela', 'bisagra', 'pernio']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'alero'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['cornisa', 'ala', 'alar', 'antetecho', 'chaperón', 'tejaroz', 'rafe', 'amigacho', 'amigote', 'ciervo', 'amigo']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'pilar'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['columna', 'pilastra', 'soporte', 'apoyo', 'sostén', 'hito', 'mojón', 'poste', 'pilón']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'hastío'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['empalago', 'asco', 'repugnancia', 'repulsión', 'aborrecimiento', 'disgusto', 'fastidio', 'cansancio', 'aburrimiento', 'tedio', 'fatiga', 'desgana', 'desinterés', 'apatía', 'boludez', 'indolencia', 'indiferencia']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'octavilla'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['cuartilla', 'impreso', 'pasquín', 'volante', 'panfleto', 'reoctava']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'gulusmear'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['golosinear', 'golosinar', 'golosear']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'contumacia'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['pertinacia', 'cerrilidad', 'cerrilismo', 'obstinación', 'terquedad', 'tozudez', 'testarudez', 'rebeldía']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(sinonimo === 'zurcir'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['recoser', 'remendar', 'repasar', 'componer', 'remendar']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
  ...
  if(event.key === "a" || event.key === "A"){
    ...
    if(antonimo === 'austero'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['ostentoso', 'lujoso']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(antonimo === 'victoria'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['derrota']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(antonimo === 'pánfilo'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['despierto', 'espabilado', 'avispado']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(antonimo === 'apogeo'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['decadencia', 'ocaso', 'declive']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(antonimo === 'proclive'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['reacio']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
    ...
    if(antonimo === 'auge'){
      document.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
          const solucion = prompt ('Ingresa tu respuesta: ')
          const soluciones = ['decadencia', 'declive', 'ocaso', 'decrecimiento']
          if(soluciones.includes(solucion)){
            cont1.innerHTML += `<p class="frase"><span class="fotoTick"></span><span class="respuestaCorrecta">${respuestaCorrecta}</span></p>`
          }
          else {
